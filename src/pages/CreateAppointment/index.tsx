...
const CreateAppointment: React.FC = () => {
  ...
  const handleToggleDatePicker = useCallback(() => {
    ...
    /* toda função que altera estado, eu posso passar como
    parametro uma função cujo o paramentro receberá
    o valor antigo deste estado */
  }, []);
